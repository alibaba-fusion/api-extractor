...
class Clear extends React.Component {
    ...
    render() {
        ...
        if (hint) {
            ...
            hintIcon =  <Icon type="delete-filling" className={`${prefix}input-hint`} onClick={onClick} onMouseDown={preventDefault}/>;
        }
        ...
        return <span className={`${prefix}input-hint-wrap`}>
            {hasClear && hint ? <Icon type="delete-filling" className={`${prefix}input-clear`} onClick={onClick} onMouseDown={preventDefault}/>: null}
            {hintIcon}
        </span>
    }
}
